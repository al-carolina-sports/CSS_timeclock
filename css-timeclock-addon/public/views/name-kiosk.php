...
?>
<div class="css-tc-kiosk css-tc-kiosk--names" data-kiosk="name" data-enabled="<?php echo $enabled ? '1' : '0'; ?>">
	<div class="css-tc-kiosk__chrome">
		<div class="css-tc-kiosk__brand">
			...
			<div>
				...
				<h1 class="css-tc-kiosk__title"><?php echo esc_html__( 'Find your name, then confirm with your PIN', 'css-timeclock-addon' ); ?></h1>
			</div>
		</div>
	...
	<?php else : ?>
		<div class="css-tc-kiosk__stage" data-role="stage">
			<section class="css-tc-kiosk__panel css-tc-kiosk__panel--list" data-screen="list" hidden>
				<label class="css-tc-search">
					<span class="screen-reader-text"><?php echo esc_html__( 'Search names', 'css-timeclock-addon' ); ?></span>
					<input type="search" data-role="search" placeholder="<?php echo esc_attr__( 'Search names', 'css-timeclock-addon' ); ?>" autocomplete="off" />
				</label>
				<p class="css-tc-kiosk__error" data-role="list-error" hidden></p>
				<div class="css-tc-names" data-role="names"></div>
			</section>

			<section class="css-tc-kiosk__panel" data-screen="pin" hidden>
				<p class="css-tc-kiosk__prompt" data-role="pin-prompt"><?php echo esc_html__( 'Confirm with your PIN', 'css-timeclock-addon' ); ?></p>
				<p class="css-tc-kiosk__hello css-tc-kiosk__hello--small" data-role="selected-name"></p>
